export default {
  ...
  images: {
    // Empty / keys
    emptyKeysTitle: '还没有可用的 API 密钥',
    emptyKeysDescription: '生成图片需要一个状态正常的 API 密钥，请先创建或启用一个。',
    createKey: '创建密钥',
    manageKeys: '管理密钥',
    ...
    startDescription: '在同一窗口保留本地历史，并从已有结果图继续发起新的编辑。',
    // Turn meta
    ...
    continueEdit: '加入编辑',
    countLabel: '{count} 张',
    resultNumber: '结果 {count}',
    imageNofM: '图片 {index}/{total}',
    // Status
    queued: '排队中',
    generating: '处理中',
    ...
    generatingElapsed: '已用时 {time}',
    generatingQueued: '正在排队…',
    generatingRendering: '正在绘制…',
    generatingFinalizing: '即将完成…',
    generatingPlaceholder: '生成中',
    // Actions
    retryThisImage: '重新生成这一张',
    ...
    promptPlaceholder: '输入你想要生成的画面，也可直接粘贴图片',
    generate: '生成图片',
    editImage: '编辑图片',
    addedToEdit: '已加入编辑',
    readReferenceFailed: '读取参考图失败',
    noImageData: '未返回图片数据',
    // Settings panel
    settingsTitle: '图像设置',
    apiKey: 'API 密钥',
    ...
    selectModel: '选择模型',
    loadingModels: '加载模型中…',
    loadModelsFailed: '加载模型列表失败，已回退到默认模型',
    qualityLabel: '质量',
    quality: {
      auto: '自动',
      low: '低',
    ...
    countSetting: '生成数量',
    // Confirm dialogs
    clearHistoryConfirmTitle: '清空全部历史',
    clearHistoryConfirmDescription: '将删除本地保存的所有生图记录，此操作不可恢复。',
    deleteConversationConfirmTitle: '删除该对话',
    deleteConversationConfirmDescription: '将删除该对话的全部记录，此操作不可恢复。',
    deletePromptConfirmTitle: '删除提示词记录',
    deletePromptConfirmDescription: '仅隐藏该轮的提示词文本，生成结果会保留。',
    deleteResultsConfirmTitle: '删除生成结果',
    deleteResultsConfirmDescription: '仅隐藏该轮的生成结果，提示词会保留。',
  },
  ...
  admin: {
    ...
    billing: {
      title: '账单统计',
      description: '手工记录订单成本与利润，按归属人汇总统计',
      searchPerson: '搜索归属人',
      fromDate: '开始日期',
      toDate: '结束日期',
      createRecord: '新增记录',
      editRecord: '编辑记录',
      deleteRecord: '删除记录',
      deleteConfirm: '确定要删除这条账单记录吗？',
      creating: '创建中...',
      perPersonTitle: '按归属人统计',
      noStatsData: '暂无统计数据',
      personName: '归属人',
      personNamePlaceholder: '请输入归属人',
      source: '来源',
      ...
      totalRevenue: '总营收',
      netProfit: '净利润',
      failedToLoad: '加载账单记录失败',
      failedToLoadStats: '加载账单统计失败',
      recordCreated: '账单记录已创建',
      failedToCreate: '创建账单记录失败',
      recordUpdated: '账单记录已更新',
      failedToUpdate: '更新账单记录失败',
      recordDeleted: '账单记录已删除',
      failedToDelete: '删除账单记录失败',
      columns: {
        personName: '归属人',
        source: '来源',
        cost: '成本',
